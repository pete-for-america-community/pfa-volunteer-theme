...
<?php
/* This template is called when no other, more specific templates, can be found.  For now this and page-home.php are identical. */
    ...
    <section class="hero bg-primary">
        ...
        <div class="contact-form bg-secondary">
            ...
            <div class="contact-form-wrapper">
                <?php 
                    echo "Contact Form Placeholder"; //do_shortcode('[contact-form-7 id="59" title="signup"]');
                ?>
            </div>    
        </div>
    </section>
