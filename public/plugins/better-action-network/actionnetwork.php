 ...
 * @version 1.1.2
 *
 * Plugin Name: Better Action Network
 * Description: Provides Action Network (actionnetwork.org) action embed codes as shortcodes and a calendar and signup widget -- but without the awful CSS embeds.
 * Author: jared Parmenter
